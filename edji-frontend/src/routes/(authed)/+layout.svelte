        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
           <ul class="space-y-2 font-medium">
              <li aria-current={$page.url.pathname === '/dashboard' ? 'page' : undefined}>
                 <a href="/dashboard" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
                    <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
              ...
              <li aria-current={$page.url.pathname === '/explorer' ? 'page' : undefined}>
                 <a href="/swagger" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Explorer</span>
                 </a>
              </li>
              <li aria-current={$page.url.pathname === '/logs' ? 'page' : undefined}>
                 <a href="/logs" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
              ...
              <li aria-current={$page.url.pathname === '/collection/user' ? 'page' : undefined}>
                 <a href="/collection/user" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
              ...
              <li aria-current={$page.url.pathname === '/backup' ? 'page' : undefined}>
                 <a href="/backup" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
                    ...
                    <span class="flex-1 ml-3 whitespace-nowrap">Backup / Restore</span>
                 </a>
              </li>
              <li aria-current={$page.url.pathname === '/settings' ? 'page' : undefined}>
                 <a href="/settings" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white group">
